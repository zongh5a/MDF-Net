...
def filter(dataset_root, scan, img_folder, cam_folder,
           ...
           photo_threshold=0.8, dist_threshold=1, diff_threshold=0.01, geo_check_view=3):
    """
...
if __name__=="__main__":
    ...
    parser.add_argument("-e",'--eval_folder', default="../../outputs", type=str, help='eval output location')#"../../outputs"
    ...
    parser.add_argument('-o', '--outply_folder', default=None, type=str, help='dtu or tanks')
    ...
    if args.dataset == "dtu":
        ...
        if tanks_group == "intermediate":
            ...
            #scans = ['Francis', 'Horse', 'Lighthouse', 'M60',]
            scans = ['Francis', ]
        ...
        filter_args = {
            ...
            'Francis': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.01, "geo_check_views": 5},
            'Horse': {"photo_thresh": 0.8, "dist_threshold": 0.8, "diff_threshold": 0.01, "geo_check_views": 4},
            'Lighthouse': {"photo_thresh": 0.8, "dist_threshold": 0.8, "diff_threshold": 0.01, "geo_check_views": 5},
            'M60': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.01, "geo_check_views": 4},
            'Panther': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 6},
        ...
        """
        """patchmatchnet args   2
        filter_args = {
            'Family':{"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Francis': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 6},
            'Horse': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            'Lighthouse': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 6},
            'M60': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Panther': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Playground': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Train': {"photo_thresh": 0.6, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
        }"""
        """gsmvsnet args    3
        filter_args = {
            'Family':{"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            ...
            'M60': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            'Panther': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.005, "geo_check_views": 6},
            'Playground': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.005, "geo_check_views": 6},
            'Train': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.005, "geo_check_views": 5},
        }
        """
        """ 4
        filter_args = {
            'Family': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Francis': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 7},
            'Horse': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 3},
            'Lighthouse': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 7},
            'M60': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.006, "geo_check_views": 4},
            'Panther': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.005, "geo_check_views": 6},
            'Playground': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.005, "geo_check_views": 6},
            'Train': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.005, "geo_check_views": 5},
        }
        """
        """ 53.64
        filter_args = {
            ...
            'Auditorium': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.005, "geo_check_views": 3},
            'Ballroom': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            'Courtroom': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            'Museum': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            
            'Palace': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            
            'Temple': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
        }
        """
        filter_args = {
            'Family': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            ...
            #'Francis': {"photo_thresh": 0.8, "dist_threshold": 0.6, "diff_threshold": 0.01, "geo_check_views": 5},
            #'Francis': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            'Francis': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 7},

            #'Horse': {"photo_thresh": 0.6, "dist_threshold": 0.8, "diff_threshold": 0.01, "geo_check_views": 4},
            #'Horse': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 4},
            'Horse': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            ...
            #'Palace': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 5},
            #'Palace': {"photo_thresh": 0.8, "dist_threshold": 1, "diff_threshold": 0.01, "geo_check_views": 8},
            #'Palace': {"photo_thresh": 0.6, "dist_threshold": 0.75, "diff_threshold": 0.0075, "geo_check_views": 6},
            #'Palace': {"photo_thresh": 0.6, "dist_threshold": 0.75, "diff_threshold": 0.0075, "geo_check_views": 6}, #no test
            'Palace': {"photo_thresh": 0.8, "dist_threshold": 0.8, "diff_threshold": 0.01, "geo_check_views": 5},
